	...
	<div class="container">
	  ...
	  <div class="span3">
		...
		<div class="span9">
			...
			<form action="idea.jspx?_m=edit&id=${idea.id }" method="post">
        ...
        <fieldset>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              ...
              <input type="text" class="span9" id="input01" x-webkit-speech="undefined" style="height:30px;" name="title"value="${idea.title }" />
		  ...
		  <div class="control-group">
            ...
            <div class="controls">
              ...
              <textarea name="content" id="" class="span9" rows="15">  ${idea.content } </textarea>
