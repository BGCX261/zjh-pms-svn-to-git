			...
			<ul class="nav">
			  ...
			  <li class="dropdown" id="menutest1">
				...
				<ul class="dropdown-menu">
				  <li><a href="addcontact.action"><i class="icon-user"></i>&nbsp;联系人</a></li>
				  <li><a href="#"><i class="icon-home"></i>&nbsp;公司</a></li>
				  <li class="divider"></li>
			...
			<div class="row">
				  ...
				  <div class="span8">
						...
						<div class="page-header well">
						  <h2><i class="icon-home"></i>&nbsp;添加公司</h2>	
						</div>	
						
	<div class="page-header well">
		<form class="form-horizontal" action="new_companys.action" method="post">
		  <fieldset>
			<legend>完善资料</legend>
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				<input type="text" name="company.weibo">
				 <p >输入微博名称或ID</p>
			  </div> 
			</div>
			<div class="control-group">
			  ...
			  <div class="controls">
				<textarea name="company.content" id="beijing" rows="20"cols="40"></textarea>
				 <p >简介，如何认识的等</p>
			  </div> 
			</div>
			<div class="control-group">
			  ...
			  <div class="controls">
				...
				<input class="nogroup" type="Radio" name="view" value="all" >所有同事<br/>
				<input class="nogroup" type="Radio" name="view" value="me" checked>只有我能看见<br/>
				<input id="checkgroup" type="Radio" name="view" value="grouptype" >选择一个组...<br/>
					
					<div class="grouptype" style="display:none">
						<select name="grouptype" id="grouptype">
								<c:forEach items="${groupList }" var="list">
									<option value="office">${ list.groupname}</option>
								</c:forEach>
							</select>
					</div>
